...
"""Interface to VIIRS L2 data (NASA SIPS format) """
...
class VIIRSL2FileHandler(NetCDF4FileHandler):
    ...
    def _get_dataset_valid_range(self, dataset_id, ds_info, var_path):
        valid_min = self[var_path].valid_min
        valid_max = self[var_path].valid_max
        scale_factor = None
        scale_offset = None
    ...
    def available_datasets(self, configured_datasets=None):
        ...
        for var_name, val in self.file_content.items():
            ...
            if var_name == 'geolocation_data/latitude':
